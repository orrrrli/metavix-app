...
export default function PatientDashboard() {
  const { records: patientRecords, profile: patientProfile } = usePatientData();
      ...
      <Card className="shadow-sm border-primary/20 bg-primary/[0.02]">
        ...
        <CardContent>
          {todayValues.length > 0 ? (
            ...
            <p className="text-sm text-muted-foreground py-4 text-center">No hay mediciones de glucosa recientes. <Link href="/paciente/nuevo-registro" className="text-primary underline">Registrar ahora</Link></p>
          )}
        </CardContent>
      </Card>
